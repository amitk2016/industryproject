<?php
/**
 * President-Sparrow Theme Customizer.
 *
...
function sparrow_customize_preview_js() {
	wp_enqueue_script( 'sparrow_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
